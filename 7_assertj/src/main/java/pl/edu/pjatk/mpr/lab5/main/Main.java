...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Osoby pelnoletnie: " + OrdersService.getNamesAndSurnamesCommaSeparatedOfAllClientsAbove18YearsOld(orders));
		System.out.println();
		...
		BiConsumer<ClientDetails, List<Order>> consumer = (o1, o2) -> System.out.println(o1.getLogin()+":"+ o2.listIterator().next().getComments());
		OrdersService.groupOrdersByClient(orders).forEach(consumer);
		System.out.println();
