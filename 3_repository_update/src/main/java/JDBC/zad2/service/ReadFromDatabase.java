...
private List<Orders> selectAllFromTableOrders() {
	...
	public void show() {
		...
		for (Orders order : list_Orders) {
			...
			System.out.println(order.getDelivaryAddress().getId() + " # " + order.getDelivaryAddress().getStreet() + " # " + order.getDelivaryAddress().getBuilgingNumber() + " # " + order.getDelivaryAddress().getFlatNumber() + " # " + order.getDelivaryAddress().getPostalCode() + " # " + order.getDelivaryAddress().getCity() + " # " + order.getDelivaryAddress().getCountry() + " # ");
			System.out.println ("#############################");
